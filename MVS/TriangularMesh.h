...
//#define TEST_MESHREFINE
	...
	void ALM_TVU_MeshRefinement(string meshname, double fidParam, double m_beta, double ndp_eta, double ndf_eta, double varsigma, double penParam, double regParam, double lapParam, bool UseTVU, bool UseTVNorm, int iter_step, bool UseFaceArea, bool UseMatlabSolver);
	void TV_JacobianMatrix_Construction(MyMesh& T_mesh, RowSparseMatrix& mat_J, DenseMatrix& mat_f, 
		double fidParam, double m_beta, double ndp_eta, double ndf_eta, double varsigma, double penParam, double lapParam,
	...
	void CalculateEnergyTerm(DenseMatrix mat_f, vector<double>& energy, bool UseFidelity, bool UseLaplace, bool UseGDN, bool UsePointND, bool UseFaceND, bool UseTVNorm, bool UseTVU);
