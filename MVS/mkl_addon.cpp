...
template<>
void CSRMatrix<double>::MultiVect(double* in, double *out) const
{
	if( !onebase() ) {
...
bool SparseSolver::init(const CSRMatrix<mklReal> *pMatA)
{
...
bool SparseSolver::solve(const double *b, double *x, int nRhs, int nItr, int nPrecDigit)
{
	//////////////////////////////////////////////////////////////////////////
...
// Least Square Solver
//////////////////////////////////////////////////////////////////////////
bool LeastSquareSparseSolver::init(const CSRMatrix<mklReal> &matA)
{
